...
func TestDecode_count_lines3_wf(t *testing.T) {
	...
	Expect(t, root.Steps[0].ID).ToBe("step1")
	Expect(t, root.Steps[0].Run.Workflow.ID).ToBe("wc2-tool.cwl")
...
func TestDecode_count_lines8_wf(t *testing.T) {
	...
	Expect(t, root.Steps[0].ID).ToBe("step1")
	Expect(t, root.Steps[0].Run.Workflow.ID).ToBe("count-lines1-wf.cwl")
	Expect(t, root.Steps[0].In[0].ID).ToBe("file1")
	Expect(t, root.Steps[0].In[0].Source[0]).ToBe("file1")
...
func TestDecode_count_lines10_wf(t *testing.T) {
	...
	Expect(t, root.Steps[0].Run.Workflow.Steps[0].Run.Workflow.ID).ToBe("wc-tool.cwl")
	...
	Expect(t, root.Steps[0].Run.Workflow.Steps[1].Run.Workflow.ID).ToBe("parseInt-tool.cwl")
