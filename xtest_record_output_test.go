...
func TestDecode_record_output(t *testing.T) {
	...
	Expect(t, root.Arguments[0].Binding.ValueFrom).ToBe("cat")
	Expect(t, root.Arguments[0].Binding.Position).ToBe(1)
	Expect(t, root.Arguments[1].Binding.ValueFrom).ToBe("> foo")
	...
	Expect(t, root.Arguments[3].Binding.ValueFrom).ToBe("cat")
	Expect(t, root.Arguments[3].Binding.Position).ToBe(5)
	Expect(t, root.Arguments[4].Binding.ValueFrom).ToBe("> bar")
